package com.github.arkronzxc.chat;

import ch.qos.logback.classic.Level;
import ch.qos.logback.classic.LoggerContext;
import ch.qos.logback.classic.encoder.PatternLayoutEncoder;
import com.github.arkronzxc.chat.server.Server;
...
public class Main {
    ...
    public static void configureLogger() {
        try {
            ...
            ch.qos.logback.classic.Logger logger = context.getLogger("com.github.arkronzxc.chat");
